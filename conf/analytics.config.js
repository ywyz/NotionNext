 ...
 * @LastEditors: ywyz
 * @LastEditTime: 2025-10-03 19:51:20
 */
/**
 * 站点统计插件
 */
module.exports = {
  ...
  ANALYTICS_BAIDU_ID: process.env.NEXT_PUBLIC_ANALYTICS_BAIDU_ID || '51f27e0c84a8f4629334ffc8a18acd46', // e.g 只需要填写百度统计的id，[baidu_id] -> https://hm.baidu.com/hm.js?[baidu_id]
  ...
  // 微软 Clarity 站点分析
  CLARITY_ID: process.env.NEXT_PUBLIC_CLARITY_ID || 'tngblswwq5', // 只需要复制Clarity脚本中的ID部分，ID是一个十位的英文数字组合
